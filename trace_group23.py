...
# Add Group23 to path so we can import the class
sys.path.insert(0, str(Path("Group23").absolute()))
import solution

def main():
    print("="*60)
    print("RUNNING DETAILED TRAPEZIUM PIPELINE TRACE ON NEW IMAGE.PNG (GROUP23)")
    print("="*60)
    
    # Initialize the model with Group23/models
